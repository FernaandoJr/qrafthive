...
export default function SignupFormDemo() {
  ...
  return (
    <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 mt-4 md:p-8 shadow-input bg-white dark:bg-black">
      ...
      <p className="text-neutral-600 text-sm max-w-sm mt-2 dark:text-neutral-300">Register and have an adventure with your creations</p>

      <form className="my-8" onSubmit={handleSubmit}>
        <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4">
          <LabelInputContainer>
            <Label htmlFor="firstname">Full name</Label>
            <Input id="firstname" placeholder="ex: John Dave" type="text" />
          </LabelInputContainer>
        </div>
